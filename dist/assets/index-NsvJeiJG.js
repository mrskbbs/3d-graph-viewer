...
`)+`
`+u);const T=R+d+o,C=R+u+s,V=WebGLShader(r,r.VERTEX_SHADER,T),L=WebGLShader(r,r.FRAGMENT_SHADER,C);r.attachShader(S,V),r.attachShader(S,L),t.index0AttributeName!==void 0?r.bindAttribLocation(S,0,t.index0AttributeName):t.morphTargets===!0&&r.bindAttribLocation(S,0,"position"),r.linkProgram(S);function w(F){if(i.debug.checkShaderErrors){const $=r.getProgramInfoLog(S).trim(),P=r.getShaderInfoLog(V).trim(),Y=r.getShaderInfoLog(L).trim();let q=!0,Q=!0;if(r.getProgramParameter(S,r.LINK_STATUS)===!1)if(q=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(r,S,V,L);else{const ee=getShaderErrors(r,V,"vertex"),k=getShaderErrors(r,L,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(S,r.VALIDATE_STATUS)+`
